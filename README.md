...
## Where can I get it Multilingal Platform?
 - [macOS(x64)](https://github.com/yasuking0304/desktop/releases/download/original-3.5.6/GitHub.Desktop-x64.zip)  
    For the MacOS version, please execute the included "setenv_lang_macos.sh" after installation.
You only need to run it once.

 - [Windows(x64)](https://github.com/yasuking0304/desktop/releases/download/original-3.5.6/GitHubDesktopSetup-x64.exe)
 - [Linux(x64-AppImage)](https://github.com/yasuking0304/desktop/releases/download/original-3.5.6/GitHubDesktop-linux-x86_64-3.5.6.AppImage)
